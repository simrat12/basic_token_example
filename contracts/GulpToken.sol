...
contract GulpToken is ERC20, Ownable {
    ...
    constructor() ERC20("GULP", "GULP") {
        ...
        marketingWallet = address(0x2947ef7D8FDB86134998F0EabF5EA0A9c3c02ef3);  //change this for your marketingWallet
        teamWallet = address(0x52cfb88894DBB28ECfa525A63F50e1ed424428d5); //change this for your teamWallet
        cexWallet = address(0xfAFF6108d246a78DFAD9e6F5a696b27aB5DC8424); // change this for your cexWallet
